...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active border border-dark border-1 rounded fw-bold" aria-current="page" href="index.php">Donate</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="text-center shadow p-3 mt-2 mb-4 rounded" style="background-color: #e3e154;">
            <h1 class="display-4">Donner Information</h1>
            <p class="text-danger fw-bold">Contact the donner to get the book</p>
        </div>
