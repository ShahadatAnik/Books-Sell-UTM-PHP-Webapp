...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active border border-dark border-1 rounded fw-bold" aria-current="page" href="">Borrow</a>
                            </li>
                        <li class="nav-item">
        ...
        <div class="text-center shadow p-3 mt-2  rounded" style="background-color: #e3e154;">
            <h1 class="display-4">Borrow Books</h1>
                    ...
                    <div class="col d-flex justify-content-center mt-2">
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Days: <?= $row["borrow_time"]; ?></p>
                                <?php
                                if ($_SESSION['studentid'] == $row['owner_id']) {
                                    echo "<a class='btn btn-danger' href='mark_as_borrowed.php?book_id=" . $row['id'] . "'>Mark as Borrowed</a>";
                                } else {
                                    echo "<a class='btn btn-primary' href='details.php?id=" . $row['owner_id'] . "'>Borrow</a>";
                                }
                                ?>
                            </div>
                        </div>
